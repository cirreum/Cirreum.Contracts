...
/// query-caching intercept prepends to the request's cache key and tags at cache time.
/// </summary>
/// <remarks>
/// <para>
/// When no prefix is set, the query-caching intercept uses the request's key and tags as-is.
