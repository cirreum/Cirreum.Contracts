...
public static class AuthorizationTelemetry {
	...
	/// <summary>Stage 1, Step 0s — self-identity gate.</summary>
	public const string StepSelfIdentity = "self-identity";

	/// <summary>Stage 1, Step 1 — authorization-constraint chain.</summary>
	...
	/// </summary>
	public static void RecordGrantResolution(
		string? feature,
		string? resourceType,
		string cacheLevel,
